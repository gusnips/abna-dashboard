...
export function Header({ selectedCSR }: HeaderProps) {
    return (
        <>
            {/* Faixa de marca global — banner em largura total; a barra fixa surge ao rolar */}
            <img
                src={headerImage}
                ...
                <div className="relative container mx-auto px-4 py-4">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        >
                            ...
                            />
                            {/* Título disponível para leitores de tela/SEO; a marca visual
                                principal vive no banner acima, evitando dupla identidade. */}
